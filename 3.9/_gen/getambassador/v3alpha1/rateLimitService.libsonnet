{
  ...
  spec: {
    ...
    grpc: {
      ...
      withUse_resource_exhausted_code(use_resource_exhausted_code): { spec+: { grpc+: { use_resource_exhausted_code: use_resource_exhausted_code } } },
    },
