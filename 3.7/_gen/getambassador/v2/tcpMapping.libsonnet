{
  ...
  '#':: d.pkg(name='tcpMapping', url='', help='"TCPMapping is the Schema for the tcpmappings API"'),
  ...
  '#spec':: d.obj(help='"TCPMappingSpec defines the desired state of TCPMapping"'),
  spec: {
    ...
    '#withIdle_timeout_ms':: d.fn(help="\"FIXME(lukeshu): Surely this should be an 'int'?\"", args=[d.arg(name='idle_timeout_ms', type=d.T.string)]),
    withIdle_timeout_ms(idle_timeout_ms): { spec+: { idle_timeout_ms: idle_timeout_ms } },
    '#withPort':: d.fn(help="\"Port isn't a pointer because it's required.\"", args=[d.arg(name='port', type=d.T.integer)]),
