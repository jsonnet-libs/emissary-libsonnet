{
  ...
  spec: {
    ...
    '#withAllow_request_body':: d.fn(help='', args=[d.arg(name='allow_request_body', type=d.T.boolean)]),
    ...
    '#withAuth_service':: d.fn(help='', args=[d.arg(name='auth_service', type=d.T.string)]),
    ...
    '#withV3CircuitBreakers':: d.fn(help='', args=[d.arg(name='v3CircuitBreakers', type=d.T.array)]),
    withV3CircuitBreakers(v3CircuitBreakers): { spec+: { v3CircuitBreakers: if std.isArray(v=v3CircuitBreakers) then v3CircuitBreakers else [v3CircuitBreakers] } },
    '#withV3CircuitBreakersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='v3CircuitBreakers', type=d.T.array)]),
    withV3CircuitBreakersMixin(v3CircuitBreakers): { spec+: { v3CircuitBreakers+: if std.isArray(v=v3CircuitBreakers) then v3CircuitBreakers else [v3CircuitBreakers] } },
