---
permalink: /3.8/getambassador/v3alpha1/kubernetesEndpointResolver/
---

# getambassador.v3alpha1.kubernetesEndpointResolver
...
new returns an instance of KubernetesEndpointResolver
